    ...
    <div id="workcenter">
        <div class="flex flex-row items-center justify-between pb-5">
            ...
            <div v-if="props.toolbar" class="flex flex-row text-teal">
                ...
                <div class="flex flex-row items-center ml-[40px] text-[16px] cursor-pointer" @click="exportExcel">
            ...
            <div class="ma-2">
                <Grid :data-items="grid" :columns="columns" :skip="skip" :take="take" :total="count"
                    ...
                    <template v-slot:dateTemplate="{ props, listeners }">
                        <td>
                            <div v-if="props.dataItem[props.field]">{{ dateFormatter.format(props.dataItem[props.field]) }}</div>
                            <div v-else>&nbsp;</div>
                        </td>
                    </template>
                    ...
                    <template v-slot:statusTemplate="{ props, listeners }">
                        <td>
                            <span :class="
                                ...
                                : props.dataItem[props.field] === 'Cost allocation pre-approval' ? 'text-pink-400'
                                    : props.dataItem[props.field] === 'Create' ? 'text-blue-500'
                                    : props.dataItem[props.field] === 'Purchasing' ? 'text-blue-400'
                                        : props.dataItem[props.field] === 'Closing' ? 'text-orange-500'
                                            : props.dataItem[props.field] === 'Closed' ? 'text-red-500'
                                                ...
                                                : props.dataItem[props.field] === 'Pre-approval' ? 'text-green-400'
                                                : props.dataItem[props.field] === 'Canceled' ? 'text-gray-300'
                                                    : ''
                            ">
                                {{ props.dataItem[props.field] }}
                            </span>
                            <!-- Cost allocation Approval - pink
                                Cost allocation pre-approval - pink >
                                Purchasing - blue >
                                Create - blue
                                Closing - orange
                                Closed - red
...
import { useGridOptions } from '../../Grid/GridOptionsRequest';
...
const columns = ref<GridColumnProps[]>([
    { field: 'ReferenceNumber', type: 'number', title: 'Ref nr', hidden: false },
    { field: 'Title', type: 'string', title: 'Title', cell: 'titleTemplate', hidden: false },
    { field: 'RequestOwner', type: 'string', title: 'Request owner', hidden: false },
    { field: 'CurrentStateName', type: 'string', title: 'Current state', cell: 'statusTemplate', hidden: false },
    { field: 'CreatedDate', type: 'date', title: 'Created date', cell: 'dateTemplate', hidden: false },
    { field: 'ModifiedDate', type: 'date', title: 'Modified date', cell: 'dateTemplate', hidden: false },
    { field: 'Approvers', type: 'string', title: 'Current approver', hidden: false },
    { field: 'ApprovalGroups', type: 'string', title: 'Approval groups', hidden: false },
    { field: 'TotalCostDisplay', type: 'string', title: 'Total cost', hidden: false },
...
const { data, error, loading, count } = useEngage<Request>(ref(`/api/Requests?${odataURl}`), authToken);
...
//                 {
//                     "RequestID": 72465,
//                     "ReferenceNumber": 2264,
//                     "Title": "budget test 4",
//                     "CurrentStateID": 50,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
//                     "RequestOwner": "FraxionTempAdmin FTA",
//                     "CurrentStateName": "Purchasing",
//                     "ExReferenceNumber": null,
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 3516.3150,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686650464730)\/",
//                     "ModifiedDate": "\/Date(1686650471737)\/",
//                     "TotalCostDisplay": "$3,516.32",
//                     "Approvers": "",
//                     "ApprovalGroups": "Auto"
//                 },
//                 {
//                     "RequestID": 72464,
//                     "ReferenceNumber": 2263,
//                     "Title": "budget test 2",
//                     "CurrentStateID": 50,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
...
//                     "TotalCost": 3516.3150,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686650442307)\/",
//                     "ModifiedDate": "\/Date(1686650455313)\/",
//                     "TotalCostDisplay": "$3,516.32",
//                     "Approvers": "",
//                     "ApprovalGroups": "Auto"
//                 },
//                 {
//                     "RequestID": 72463,
//                     "ReferenceNumber": 2262,
//                     "Title": "budget test 2",
//                     "CurrentStateID": 20,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
//                     "RequestOwner": "FraxionTempAdmin FTA",
//                     "CurrentStateName": "Approval",
//                     "ExReferenceNumber": null,
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 3516.3150,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686650415753)\/",
//                     "ModifiedDate": "\/Date(1686663004403)\/",
//                     "TotalCostDisplay": "$3,516.32",
//                     "Approvers": "Thanh Nguyen",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
//                     "RequestID": 72462,
//                     "ReferenceNumber": 2261,
//                     "Title": "budget test",
//                     "CurrentStateID": 20,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
...
//                     "TotalCost": 3516.3150,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686650056783)\/",
//                     "ModifiedDate": "\/Date(1686661208587)\/",
//                     "TotalCostDisplay": "$3,516.32",
//                     "Approvers": "Thanh Nguyen",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
//                     "RequestID": 72461,
//                     "ReferenceNumber": 2260,
//                     "Title": "test",
//                     "CurrentStateID": 21,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
//                     "RequestOwner": "FraxionTempAdmin FTA",
//                     "CurrentStateName": "Pre-approval",
//                     "ExReferenceNumber": null,
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 1099.9000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686580194660)\/",
//                     "ModifiedDate": "\/Date(1686592810767)\/",
//                     "TotalCostDisplay": "$1,099.90",
//                     "Approvers": "Thanh Nguyen",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
...
//                     "CompanyID": 6657,
//                     "RequestOwner": "FraxionTempAdmin FTA",
//                     "CurrentStateName": "Create",
//                     "ExReferenceNumber": null,
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 0.0000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686580103943)\/",
//                     "ModifiedDate": "\/Date(1686580103943)\/",
...
//                     "TotalCost": 222.0000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686128958983)\/",
//                     "ModifiedDate": "\/Date(1686128968330)\/",
//                     "TotalCostDisplay": "$222.00",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
...
//                     "TotalCost": 5274.4750,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1686055569333)\/",
//                     "ModifiedDate": "\/Date(1686055569333)\/",
//                     "TotalCostDisplay": "$5,274.48",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
...
//                     "TotalCost": 2000.0000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1685002178290)\/",
//                     "ModifiedDate": "\/Date(1685002229357)\/",
//                     "TotalCostDisplay": "$2,000.00",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
//                     "RequestID": 72295,
//                     "ReferenceNumber": 2250,
//                     "Title": "EFT Demo",
//                     "CurrentStateID": 21,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
...
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 11008.9000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1682928939590)\/",
//                     "ModifiedDate": "\/Date(1682940627067)\/",
//                     "TotalCostDisplay": "$11,008.90",
//                     "Approvers": "Thanh Nguyen",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
//                     "RequestID": 72279,
//                     "ReferenceNumber": 2248,
//                     "Title": "budget test",
//                     "CurrentStateID": 21,
//                     "RequestTypeID": 1,
//                     "CompanyID": 6657,
...
//                     "TotalCost": 6116.0500,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1682593076410)\/",
//                     "ModifiedDate": "\/Date(1682604009407)\/",
//                     "TotalCostDisplay": "$6,116.05",
//                     "Approvers": "Thanh Nguyen",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
...
//                     "TotalCost": 11008.9000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1680693431197)\/",
//                     "ModifiedDate": "\/Date(1680693431197)\/",
//                     "TotalCostDisplay": "$11,008.90",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
...
//                     "ExIsError": false,
//                     "ExSystemState": "",
//                     "TotalCost": 110098.9000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1680520863090)\/",
//                     "ModifiedDate": "\/Date(1680520863090)\/",
//                     "TotalCostDisplay": "$110,098.90",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 },
//                 {
...
//                     "TotalCost": 11008.9000,
//                     "HasAttachments": false,
//                     "CreatedDate": "\/Date(1680259918960)\/",
//                     "ModifiedDate": "\/Date(1680259918960)\/",
//                     "TotalCostDisplay": "$11,008.90",
//                     "Approvers": "",
//                     "ApprovalGroups": "ABC All Divisions Approval"
//                 }
